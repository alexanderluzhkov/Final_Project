...
def get_credentials():
    """Authenticates and returns credentials for Gmail and Google Sheets APIs."""
    creds = None
    ...
    print("Client Secrets File:", client_secrets_file)
    print("Token File:", token_file)

    # Remove any existing token.json file to start fresh
    if os.path.exists(token_file):
        os.remove(token_file)
        print("Old token.json deleted.")
